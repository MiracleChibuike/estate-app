...
const LogIn = () => {
  ...
  const showPassword = () => {
    if (user_password.current.type == "password") {
      user_password.current.type = "text";
  ...
  // Hide Password back
  const hidePassword = () => {
    if (user_password.current.type == "text") {
      user_password.current.type = "password";
        ...
        <div className="logInContents">
          ...
          {isUserFound && (
            <div className="errorDisplay">
              <p>
                {" "}
                <i class="fa-solid fa-triangle-exclamation"></i> Error - No such
                user found <br /> or Incorrect credentials entered
              </p>
            </div>
          )}
          {isLoggedIn && (
            <div className="successMsg" style={{ textAlign: "center" }}>
              <p>
                ...
                <br />
                <strong style={{ marginLeft: "5px" }}>Log In Successful</strong>
              </p>
            </div>
          )}
